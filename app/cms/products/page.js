          ...
          <div className="relative w-full max-w-4xl max-h-[85vh] overflow-y-auto rounded-3xl border border-slate-200 bg-white shadow-2xl shadow-slate-300/40">
            ...
            {editLoading ? (
              ...
              <form onSubmit={handleEditSubmit} className="px-6 py-8 space-y-8">
                ...
                {editError && (
                  <div className="rounded-xl border border-red-400/30 bg-red-500/10 px-4 py-3 text-sm text-red-800">
                    {editError}
                  </div>
                )}

                {editMessage && (
                  <div className="rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-900">
                    {editMessage}
                  </div>
                )}
